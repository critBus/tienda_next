...
describe("GET /api/product/recommended (integration)", () => {
  ...
  it("should return best selling products from the real database", async () => {
    const req = {
      url: `http://localhost/api/product/recommended?provinceId=${location.provinceId}&municipalityId=${location.municipalityId}&townId=${location.townId}`,
    };
